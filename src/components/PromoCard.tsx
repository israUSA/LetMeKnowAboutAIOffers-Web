...
export function PromoCard({ promo, index, expanded, onToggle }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-auto flex flex-wrap items-center justify-between gap-x-3 gap-y-3 p-5 pt-4">
        ...
        <a
          ...
          className="inline-flex min-h-[44px] shrink-0 items-center gap-1.5 rounded-xl bg-gradient-to-r from-indigo-500 to-fuchsia-500 px-4 py-2 text-xs font-semibold text-white shadow-lg shadow-fuchsia-500/25 transition-all duration-300 hover:shadow-fuchsia-500/40 hover:brightness-110 active:scale-95"
        >
          Reclamar
